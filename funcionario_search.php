...
<?php if($_SESSION['log'] == "logado"){?>
	<html lang="pt-br">
		...
		<body>
		<?php include_once("header_funcionario_search.php")?>
		<div class="container theme-showcase" role="main">
			<div class="page-header">		
				...
				<a href="http://localhost/estock-master/produto.php"><button type="button" class="quadrinhoarredondadoexemplo pull-right">Exibir Funcionários</button></a>
